...
const JobPreview: React.FC<IJobPreview> = ({ workId, status, formData, company }) => {
  ...
  return (
    <div className="mb-12">
      <AboutCompany workId={workId} status={status} formData={formData} company={company} role={role} openModal={openDeleteModal} />
