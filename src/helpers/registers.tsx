...
export const registers: Registers = {
  ...
  courseDescription: {
    required: 'ԸԴասընթացի մասին դաշտը պարտադիր է',
    minLength: {
      value: 1,
    ...
    maxLength: {
      value: 500,
      message: 'Դասընթացի մասին դաշտը պետք է ունենա առավելագույնը 500 նիշ',
    },
  },
  classHours: {
    required: 'Դասաժամերի մասին դաշտը պարտադիր է',
    minLength: {
      value: 1,
    ...
    maxLength: {
      value: 20,
      message: 'Դասաժամերի մասին դաշտը պետք է ունենա առավելագույնը 20 նիշ',
    },
  },
  program: {
    required: 'Ծրագիր դաշտը պարտադիր է',
    minLength: {
      value: 1,
  ...
  learn: {
    ...
    maxLength: {
      value: 50,
      message: 'Ի՞նչ եք սովորելու դաշտը պետք է ունենա առավելագույնը 50 նիշ',
    },
  },
  filedStudyId: {
  ...
  responsibilities: {
    ...
    maxLength: {
      value: 1024,
      message: 'Պարտականություններ դաշտը պետք է ունենա առավելագույնը 1024 նիշ',
    },
  },
  skills: {
    ...
    maxLength: {
      value: 1024,
      message: 'Անհրաժեշտ հմտություններ դաշտը պետք է ունենա առավելագույնը 1024 նիշ',
    },
  },
  rejectText: {
    required: 'Մերժման պատճառ դաշտը պարտադիր է',
    minLength: {
      value: 3,
      message: 'Մերժման պատճառ դաշտը պետք է ունենա առնվազն 3 նիշ',
    },
    maxLength: {
      value: 1024,
      message: 'Մերժման պատճառ դաշտը պետք է ունենա առավելագույնը 1024 նիշ',
    },
  },
};
